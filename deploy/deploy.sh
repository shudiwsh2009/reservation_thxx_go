...
chmod a+x ./server/server.run
nohup ./server/server.run --app-env="ONLINE" --sms-uid="shudiwsh2009" --sms-key="946fee2e7ad699b065f1" > log/server.log 2>&1 & echo $! > ~/thxxfzzx_go/run.pid &
...
#0 20 * * * ~/thxxfzzx_go/server/reminder.run --app-env="ONLINE" --sms-uid="shudiwsh2009" --sms-key="946fee2e7ad699b065f1"
echo "restart cron"
